...
from seguridad.models import Modulos, ModulosElementos,ModulosElementosDef, Perfiles, PerfilesOpciones, Perfiles, PerfilesClinica, PerfilesClinicaOpciones, PerfilesUsu
