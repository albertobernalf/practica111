...
def validaAcceso(request):
    ...
    miConexion = pyodbc.connect(
        'DRIVER={SQL Server};SERVER=CMKSISTEPC07\MEDICAL;DATABASE=vulnerable ;Trusted_Connection=yes ;UID=sa;pwd=75AAbb??')
    cur = miConexion.cursor()
    comando = "SELECT id ,nombre FROM dbo.planta_tiposPlanta"
    cur.execute(comando)
    print(comando)
    ...
    comando = "select p.id  Username_id , p.nombre profesional from dbo.planta_planta p where p.documento ='" + username + "'"
    ...
    if planta == []:
        ...
        miConexion1 = pyodbc.connect(
            'DRIVER={SQL Server};SERVER=CMKSISTEPC07\MEDICAL;DATABASE=vulnerable ;Trusted_Connection=yes ; UID=sa;pwd=75AAbb??')
        cur1 = miConexion1.cursor()
        comando = "select p.contrasena contrasena from dbo.planta_planta p where p.documento ='" + username + "'" + " AND contrasena = '" + contrasena +"'"
        ...
        if plantaContrasena == []:
            ...
            miConexion2 = pyodbc.connect(
                'DRIVER={SQL Server};SERVER=CMKSISTEPC07\MEDICAL;DATABASE=vulnerable ;Trusted_Connection=yes ; UID=sa;pwd=75AAbb??')
            cur2 = miConexion2.cursor()
            comando = "select perf.tiposPlanta_id  perfil from dbo.planta_planta p , planta_perfilesplanta perf , planta_tiposPlanta tp where  p.sedesClinica_id = perf.sedesClinica_id and  p.sedesClinica_id ='" + str(sede) + "' AND p.documento =  '" + str(username) + "' AND perf.planta_id = p.id AND  perf.tiposPlanta_id = " + str(perfilConseguido)
            print(comando)
            ...
            if perfil == []:
              ...
              #  detalle = "SELECT  tp.nombre tipoDoc,  u.documento documento, u.nombre  nombre , i.consec consec , fechaIngreso , fechaSalida, ser.nombre servicioNombreIng, dep.nombre camaNombreIng , dxIngreso_id FROM dbo.admisiones_ingresos i, dbo.usuarios_usuarios u, sitios_dependencias dep , clinico_servicios ser ,usuarios_tiposDocumento tp  WHERE i.sedesClinica_id = dep.sedesClinica_id AND i.serviciosActual_id = dep.servicios_id AND i.serviciosActual_id = ser.id  AND i.dependenciasActual_id = dep.id AND i.sedesClinica_id= '" +  str(Sede) + "' AND i.salidaDefinitiva = 'N' and tp.id = u.tipoDoc_id"
                ...
                detalle = "SELECT  tp.nombre tipoDoc,  u.documento documento, u.nombre  nombre , i.consec consec , fechaIngreso , fechaSalida, ser.nombre servicioNombreIng, dep.nombre camaNombreIng , diag.nombre dxActual FROM dbo.admisiones_ingresos i, dbo.usuarios_usuarios u, dbo.sitios_dependencias dep , dbo.clinico_servicios ser ,dbo.usuarios_tiposDocumento tp , dbo.sitios_dependenciastipo deptip  , dbo.clinico_Diagnosticos diag , dbo.sitios_serviciosSedes sd  WHERE sd.sedesClinica_id = i.sedesClinica_id  and   sd.servicios_id  = ser.id and  i.sedesClinica_id = dep.sedesClinica_id AND i.dependenciasActual_id = dep.id AND i.sedesClinica_id= '" + str(Sede) + "'  AND  deptip.id = dep.dependenciasTipo_id and dep.serviciosSedes_id = ser.id AND i.salidaDefinitiva = 'N' and tp.id = u.tipoDoc_id and u.id = i.documento_id and diag.id = i.dxactual_id"
                print(detalle)
                ...
                comando = "SELECT ser.id id ,ser.nombre nombre FROM dbo.sitios_serviciosSedes sed, dbo.clinico_servicios ser Where sed.sedesClinica_id ='" + str(sede) + "' AND sed.servicios_id = ser.id"
                ...
                miConexiont = pyodbc.connect(
                    'DRIVER={SQL Server};SERVER=CMKSISTEPC07\MEDICAL;DATABASE=vulnerable ;Trusted_Connection=yes ; UID=sa;pwd=75AAbb??')
                curt = miConexiont.cursor()
                comando = "SELECT sub.id id ,sub.nombre nombre  FROM dbo.sitios_serviciosSedes sed, dbo.clinico_servicios ser  , dbo.sitios_subserviciossedes sub Where sed.sedesClinica_id ='" + str(
                ...
                miConexiont = pyodbc.connect(
                    'DRIVER={SQL Server};SERVER=CMKSISTEPC07\MEDICAL;DATABASE=vulnerable ;Trusted_Connection=yes ; UID=sa;pwd=75AAbb??')
                curt = miConexiont.cursor()
                comando = "SELECT id ,nombre FROM dbo.usuarios_TiposDocumento "
                curt.execute(comando)
                print(comando)
                ...
                miConexiont = pyodbc.connect(
                    'DRIVER={SQL Server};SERVER=CMKSISTEPC07\MEDICAL;DATABASE=vulnerable ;Trusted_Connection=yes ; UID=sa;pwd=75AAbb??')
                curt = miConexiont.cursor()
                comando = "SELECT id ,nombre FROM dbo.sitios_dependencias where sedesClinica_id = '" + str(Sede) +"' AND dependenciasTipo_id = 2"
                curt.execute(comando)
                print(comando)
                ...
                miConexiont = pyodbc.connect(
                    'DRIVER={SQL Server};SERVER=CMKSISTEPC07\MEDICAL;DATABASE=vulnerable; Trusted_Connection=yes ; UID=sa;pwd=75AAbb??')
                curt = miConexiont.cursor()
                comando = "SELECT id ,nombre FROM dbo.clinico_Especialidades"
                curt.execute(comando)
                print(comando)
                ...
                miConexiont = pyodbc.connect(
                    'DRIVER={SQL Server};SERVER=CMKSISTEPC07\MEDICAL;DATABASE=vulnerable ;Trusted_Connection=yes ; UID=sa;pwd=75AAbb??')
                curt = miConexiont.cursor()
                comando = "SELECT em.id ,e.nombre FROM dbo.clinico_Especialidades e, dbo.clinico_EspecialidadesMedicos em,dbo.planta_planta pl  where em.especialidades_id = e.id and em.planta_id = pl.id AND pl.documento = '" + str(username) + "'"
                curt.execute(comando)
                print(comando)
                ...
                miConexiont = pyodbc.connect(
                    'DRIVER={SQL Server};SERVER=CMKSISTEPC07\MEDICAL;DATABASE=vulnerable ;Trusted_Connection=yes ; UID=sa;pwd=75AAbb??')
                curt = miConexiont.cursor()
                comando = "SELECT p.id id, p.nombre  nombre FROM dbo.planta_planta p ,  dbo.planta_perfilesplanta perf WHERE p.sedesClinica_id = perf.sedesClinica_id and  perf.sedesClinica_id = '" + str(Sede) + "' AND perf.tiposPlanta_id = 1 and p.id = perf.planta_id"
                ...
                comando = "SELECT e.id id, e.nombre nombre FROM dbo.clinico_tiposFolio e"
                ...
                comando = "SELECT p.id id, p.nombre  nombre FROM dbo.usuarios_tiposusuario p"
                ...
                comando = "SELECT p.id id, p.nombre  nombre FROM dbo.usuarios_tiposDocumento p"
                ...
                comando = "SELECT p.id id, p.nombre  nombre FROM dbo.sitios_centros p"
                ...
                comando = "SELECT p.id id, p.nombre  nombre FROM dbo.clinico_diagnosticos p"
                ...
                comando = "SELECT d.id id, d.nombre  nombre FROM dbo.sitios_departamentos d"
                ...
                comando = "SELECT c.id id, c.nombre  nombre FROM dbo.sitios_ciudades c"
                ...
                comando = "SELECT c.id id,c.nombre nombre, c.nomenclatura nomenclatura, c.logo logo FROM dbo.seguridad_modulos c"
...
def retornarAdmision(request, Sede, Perfil, Username, Username_id, NombreSede):
    ...
    # detalle = "SELECT  tp.nombre tipoDoc,  u.documento documento, u.nombre  nombre , i.consec consec , fechaIngreso , fechaSalida, ser.nombre servicioNombreIng, dep.nombre camaNombreIng , diag.nombre dxActual FROM admisiones_ingresos i, usuarios_usuarios u, sitios_dependencias dep , clinico_servicios ser ,usuarios_tiposDocumento tp , sitios_dependenciastipo deptip  , clinico_Diagnosticos diag  WHERE i.sedesClinica_id = dep.sedesClinica_id AND i.serviciosActual_id = dep.servicios_id AND i.serviciosActual_id = ser.id  AND i.dependenciasActual_id = dep.id AND  i.dependenciasIngreso_id = dep.id AND i.sedesClinica_id= '" + str( Sede) + "' AND dep.sedesClinica_id = i.sedesClinica_id AND i.sedesClinica_id = ser.sedesClinica_id AND deptip.id = dep.dependenciasTipo_id  AND i.salidaDefinitiva = 'N' and tp.id = u.tipoDoc_id and diag.id = i.dxactual_id"
    detalle = "SELECT  tp.nombre tipoDoc,  u.documento documento, u.nombre  nombre , i.consec consec , fechaIngreso , fechaSalida, ser.nombre servicioNombreIng, dep.nombre camaNombreIng , diag.nombre dxActual FROM dbo.admisiones_ingresos i, dbo.usuarios_usuarios u, dbo.sitios_dependencias dep , dbo.clinico_servicios ser ,dbo.usuarios_tiposDocumento tp , dbo.sitios_dependenciastipo deptip  , dbo.clinico_Diagnosticos diag  WHERE i.sedesClinica_id = dep.sedesClinica_id AND i.dependenciasActual_id = dep.id AND i.sedesClinica_id= '" + str(
    ...
    miConexiont = pyodbc.connect(
        'DRIVER={SQL Server};SERVER=CMKSISTEPC07\MEDICAL;DATABASE=vulnerable ;Trusted_Connection=yes ; UID=sa;pwd=75AAbb??')
    curt = miConexiont.cursor()
    comando = "SELECT ser.id id ,ser.nombre nombre FROM dbo.sitios_serviciosSedes sed, dbo.clinico_servicios ser Where sed.sedesClinica_id ='" + str(
    ...
    miConexiont = pyodbc.connect(
        'DRIVER={SQL Server};SERVER=CMKSISTEPC07\MEDICAL;DATABASE=vulnerable ;Trusted_Connection=yes ; UID=sa;pwd=75AAbb??')
    curt = miConexiont.cursor()
    comando = "SELECT id ,nombre FROM dbo.sitios_dependencias where sedesClinica_id = '" + str(
    ...
    miConexiont = pyodbc.connect(
        'DRIVER={SQL Server};SERVER=CMKSISTEPC07\MEDICAL;DATABASE=vulnerable ;Trusted_Connection=yes ; UID=sa;pwd=75AAbb??')
    curt = miConexiont.cursor()
    comando = "SELECT p.id id, p.nombre  nombre FROM dbo.planta_planta p , dbo.planta_perfilesplanta perf WHERE perf.sedesClinica_id = '" + str(
...
def validaPassword(request, username, contrasenaAnt,contrasenaNueva,contrasenaNueva2):
    ...
    miConexion1 = pyodbc.connect(
        'DRIVER={SQL Server};SERVER=CMKSISTEPC07\MEDICAL;DATABASE=vulnerable ;Trusted_Connection=yes ; UID=sa;pwd=75AAbb??')
    cur1 = miConexion1.cursor()
    comando = "SELECT documento,contrasena FROM dbo.planta_planta WHERE documento = '" + str(username) + "'"
    print(comando)
    cur1.execute(comando)
    ...
    if UsuariosHc == []:
        ...
        miConexion1 = pyodbc.connect(
            'DRIVER={SQL Server};SERVER=CMKSISTEPC07\MEDICAL;DATABASE=vulnerable ;Trusted_Connection=yes ; UID=sa;pwd=75AAbb??')
        cur1 = miConexion1.cursor()
        comando = "SELECT documento,contrasena FROM dbo.planta_planta WHERE documento = '" + str(username) + "' AND contrasena = '" + str(contrasenaAnt) + "'"
        print(comando)
        cur1.execute(comando)
...
def buscarAdmision(request):
    ...
    miConexiont = pyodbc.connect(
        'DRIVER={SQL Server};SERVER=CMKSISTEPC07\MEDICAL;DATABASE=vulnerable ;Trusted_Connection=yes ; UID=sa;pwd=75AAbb??')
    curt = miConexiont.cursor()
    comando = "SELECT p.id id, p.nombre  nombre FROM dbo.planta_planta p ,  dbo.planta_perfilesplanta perf WHERE p.sedesClinica_id = perf.sedesClinica_id and  perf.sedesClinica_id = '" + str(
        Sede) + "' AND perf.tiposPlanta_id = 1 and p.id = perf.planta_id"
    ...
    miConexiont = pyodbc.connect(
        'DRIVER={SQL Server};SERVER=CMKSISTEPC07\MEDICAL;DATABASE=vulnerable ;Trusted_Connection=yes ; UID=sa;pwd=75AAbb??')
    curt = miConexiont.cursor()
    comando = "SELECT d.id id, d.nombre  nombre FROM dbo.sitios_dependencias d WHERE d.id = '" + str(BusHabitacion) + "'"
    curt.execute(comando)
    print(comando)
...
def buscarCiudades(request):
    ...
    comando = "SELECT c.id id, c.nombre  nombre FROM dbo.sitios_departamentos d, dbo.sitios_ciudades c WHERE c.departamentos_id = d.id and d.id = '" + str(Departamento) + "'"
...
def buscarEspecialidadesMedicos(request):
    ...
    comando = "SELECT p.id id, p.nombre  nombre FROM dbo.planta_planta p ,  dbo.planta_perfilesplanta perf  , dbo.clinico_especialidadesmedicos espmed WHERE p.sedesClinica_id = perf.sedesClinica_id and  perf.sedesClinica_id = '" + str(
...
def buscarHabitaciones(request):
    ...
    if Exc == 'N':
      ...
      comando = "SELECT dep.id id ,dep.numero nombre  FROM dbo.sitios_serviciosSedes sed, dbo.clinico_servicios ser  , dbo.sitios_subserviciossedes sub , dbo.sitios_dependencias dep  Where sed.sedesClinica_id ='" + str(
        ...
        comando = "SELECT dep.id id ,dep.numero nombre  FROM dbo.sitios_serviciosSedes sed, dbo.clinico_servicios ser  , dbo.sitios_subserviciossedes sub , dbo.sitios_dependencias dep , dbo.sitios_dependenciasActual act   Where sed.sedesClinica_id ='" + str(
            ...
            SubServ) + "' and act.dependencias_id = dep.id and act.disponibilidad = 'L' UNION SELECT dep.id id ,dep.numero nombre FROM dbo.sitios_serviciosSedes sed, dbo.clinico_servicios ser , dbo.sitios_subserviciossedes sub , dbo.sitios_dependencias dep Where sed.sedesClinica_id ='" + str(Sede) + "'  AND sed.servicios_id = ser.id and sed.sedesClinica_id = sub.sedesClinica_id and sed.servicios_id =sub.servicios_id and dep.sedesClinica_id=sed.sedesClinica_id and dep.servicios_id = sub.servicios_id and dep.subServicios_id =sub.id and dep.subServicios_id = '" + str(SubServ) + "' and not EXISTS  (select act.id from dbo.sitios_dependenciasactual act where act.dependencias_id = dep.id)"
    ...
    if request.method == 'POST':
       ...
       #print("extraServicio = ", extraServicio)
        ...
        miConexiont = pyodbc.connect(
            'DRIVER={SQL Server};SERVER=CMKSISTEPC07\MEDICAL;DATABASE=vulnerable ;Trusted_Connection=yes ; UID=sa;pwd=75AAbb??')
        curt = miConexiont.cursor()
        comando = "SELECT id ,disponibilidad nombre FROM dbo.sitios_dependenciasActual WHERE dependencias_id = '" + str(dependenciasIngreso) + "'"
        curt.execute(comando)
        print(comando)
        ...
        if dependenciasActual != []:
            ...
            comando = "SELECT id ,disponibilidad nombre FROM dbo.sitios_dependenciasActual WHERE dependencias_id = '" + str(
                dependenciasIngreso) + "'"
            curt.execute(comando)
            print(comando)
...
def UsuariosModal(request):
        ...
        miConexiont = pyodbc.connect(
            'DRIVER={SQL Server};SERVER=CMKSISTEPC07\MEDICAL;DATABASE=vulnerable ;Trusted_Connection=yes ; UID=sa;pwd=75AAbb??')
        curt = miConexiont.cursor()
        comando = "SELECT nombre, documento, genero, departamentos_id, ciudades_id, direccion, telefono, contacto, centrosc_id, tipoDoc_id, tiposUsuario_id FROM dbo.usuarios_usuarios WHERE tipoDoc_id = " + str(tipoDoc) + " AND documento = " + str(documento) + ""
        print(comando)
        curt.execute(comando)
...
def guardarUsuariosModal(request):
    ...
    miConexion11 = pyodbc.connect(
        'DRIVER={SQL Server};SERVER=CMKSISTEPC07\MEDICAL;DATABASE=vulnerable ;Trusted_Connection=yes ; UID=sa;pwd=75AAbb??')
    cur11 = miConexion11.cursor()
    comando = "SELECT id, tipoDoc_id, documento FROM dbo.usuarios_usuarios WHERE tipoDoc_id = '" + str(tipoDoc_id) + "' AND documento = '" + str(documento) + "'"
    print(comando)
